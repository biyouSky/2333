...
void UIWinShell::ShowPlugINMsg( const string msg )
{
}
...
HMODULE __stdcall  GetCurrentModule()
{  
	// 没有使用宏判断windows的版本
	...
	//可转换为IMAGE_DOS_HEADER（内存中的），本来就是  
    return (HMODULE)(DWORD)membinfo.AllocationBase;			
} 
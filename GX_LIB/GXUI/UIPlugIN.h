...
// 信息说明
typedef char* (*PFunc_PlugIN_Info)();
...
// menu信息
typedef std::string* (*PFunc_PlugIN_Menu)( int& num );
...
public:
	...
	void SetMainBarTipMsg( std::string msg );

	void SetBKImage( int id, int pos, int alphy=50 );
...
private:
	...
	// 透视墙纸
	int _bgImageID;
	int _bgImagePos;						// 0:平铺 1:左上 2:右上 3:坐下 4:右下 5:左中 6:右中 7:上中 8:下中
	int _bgImageAlphy;
};
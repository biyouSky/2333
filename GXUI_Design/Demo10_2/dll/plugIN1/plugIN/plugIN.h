...
extern "C" __declspec(dllexport) char* PlugINInfor();
...
// menu信息
extern "C" __declspec(dllexport) int PlugINMenuCount();
extern "C" __declspec(dllexport) const char* PlugINMenuCell( int index );

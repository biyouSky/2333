...
{
	gUILocker.CreateDirect( pPara1, *pPara2, UILayoutCalc::SIZE_X|UILayoutCalc::SIZE_Y );
}
...
__declspec(dllexport) void PlugINSetShow( bool flag )
{
	...
	gUILocker.ShowWindowDirect( flag );
}
...
{
	num = 3;
	static string mList[3] = { "管理", "数据", "查询" };
...
{
	UIPostMessage( &gUILocker, WM_NOTIFY, ID_MAINBAR, param );
}
